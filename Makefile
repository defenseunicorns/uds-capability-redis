...
build/all: build build/zarf build/zarf-init build/dubbd-k3d build/uds-capability-redis ##
...
build/uds-capability-redis: | build ## Build the redis capability
...
deploy/all: deploy/init deploy/dubbd-k3d deploy/uds-capability-redis ##
...
.PHONY: all
all: build/all cluster/reset deploy/all ## Build and deploy redis locally
